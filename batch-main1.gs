// 栗野さん用
function executeBatchSqlQuery1() {
  ...
  const settingSheetName = 'setting1'; //scriptProperties.getProperty('settingSheetName');
    ...
    try {
      ...
      for (let count = 0; count < 3; count++) {
        ...
        if (result.rowCount) {
          ...
          rowCount = result.rowCount; // indexの1行をCountから引く
        }
        else {
